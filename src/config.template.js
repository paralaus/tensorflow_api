...
module.exports = {
    ...
    server: {
        ...
        cors: {
            /* 
                origin: Belirtilen kaynaklara ['https://example.com', 'https://subdomain.example.com', 'http://localhost:3010'] veya belirtilmemişse tüm kaynaklara izin ver: Yalnızca GET ve POST'a yöntemlerine izin ver
            */
            origin: '*',
            methods: ['GET', 'POST'],
        },
    ...
    jwt: {
         ...
         */
        key: 'saigmvideochatsfu_jwt_secret',
        exp: '1h',
    },
    oidc: {
        /*
        ...
        */
        ...
        config: {
            ...
            secret: 'saigmvideochatsfu-oidc-secret',
            authorizationParams: {
                response_type: 'code',
    ...
    host: {
        ...
        */
        ...
        users_api_secret_key: 'saigmvideochatweb_default_secret',
        users: [
            {
                username: 'username',
                password: 'password',
    ...
    ui: {
        /*
            SAI-GM Video Chat örneğinizi özelleştirin
        */
        brand: {
            app: {
