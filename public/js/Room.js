...
let swalBackground = 'radial-gradient(#E5D3B3, #664229)'; //'rgba(0, 0, 0, 0.7)';
...
function initClient() {
    ...
    if (!DetectRTC.isMobileDevice) {
        ...
        setTippy('closeEmojiPickerContainer', 'Kapa', 'bottom');
        setTippy('mySettingsCloseBtn', 'Kapa', 'bottom');
        setTippy(
            'switchPushToTalk',
            'Aktifse, SpaceBar tuşuna basıldığında mikrofon devam ettirilecek, tuşa basıldığında telsiz gibi duraklatılacaktır.',
            'right',
        );
        ...
        setTippy(
            'switchBroadcasting',
            'Yayıncılık, ses veya video içeriğinin geniş bir izleyici kitlesine (birden çoğuna) yayılmasıdır.',
            'right',
        );
        setTippy(
            'switchLobby',
            'Lobi modu, yalnızca moderatörün resmi onayından sonra kişilerin toplantıya girmesine izin vererek toplantınızı korumanıza olanak tanır',
            'right',
        );
        setTippy('initVideoAudioRefreshButton', 'Ses/video cihazlarını yenileyin', 'top');
        setTippy('switchPitchBar', 'Ses seviyesi çubuğunu aç/kapa', 'right');
        setTippy('switchSounds', 'Ses bildirimlerini aç/kapa', 'right');
        setTippy('switchShare', "Katılma sırasında 'Odayı Paylaş' penceresini göster", 'right');
        setTippy('roomId', 'Oda adı (kopyalamak için tıklayın)', 'right');
        setTippy('sessionTime', 'Oturum süresi', 'right');
        setTippy('recordingImage', 'Kaydı aç/kapa', 'right');
        setTippy(
            'switchHostOnlyRecording',
            'Yalnızca toplantı sahibi (sunum yapan kişi) toplantıyı kaydetme olanağına sahiptir',
            'right',
        );
        setTippy(
            'switchH264Recording',
            'Opus codecleri ile VP8 veya Opus codecleri ile VP9 yerine AAC ile h.264 e veya Opus codecleri ile h.264 e öncelik verin',
            'right',
        );
        setTippy('switchServerRecording', 'Kayıt yerel olarak değil sunucuda saklanacak', 'right');
        setTippy('whiteboardGhostButton', 'Şeffaf arka planı aç/kapa', 'bottom');
        ...
        setTippy('whiteboardRedoBtn', 'Yenile', 'bottom');
        setTippy('whiteboardImgFileBtn', 'Resim dosyası ekle', 'bottom');
        setTippy('whiteboardPdfFileBtn', 'Pdf dosyası ekle', 'bottom');
        setTippy('whiteboardImgUrlBtn', 'Resim URL si ekle', 'bottom');
        setTippy('whiteboardTextBtn', 'Yazı ekle', 'bottom');
        ...
        setTippy('whiteboardLockButton', 'Etkinleştirilirse katılımcılar etkileşimde bulunamaz', 'right');
        ...
        setTippy('showChatOnMsg', 'Yeni mesajda sohbeti göster', 'bottom');
        setTippy('speechIncomingMsg', 'Gelen mesajları konuş', 'bottom');
        setTippy('chatSpeechStartButton', 'Konuşma tanımayı başlat', 'top');
        ...
        setTippy('chatTogglePin', 'Sabitlemeyi aç/kapa', 'bottom');
        setTippy('chatHideParticipantsList', 'Gizle', 'bottom');
        setTippy('chatShowParticipantsList', 'Katılımcı listesini aç/kapa', 'bottom');
        setTippy('chatMaxButton', 'Büyüt', 'bottom');
        setTippy('chatMinButton', 'Küçült', 'bottom');
        setTippy('participantsSaveBtn', 'Katılımcıların bilgilerini kaydet', 'bottom');
        setTippy('participantsRaiseHandBtn', 'El kaldırmayı aç/kapa', 'bottom');
        setTippy('participantsUnreadMessagesBtn', 'Okunmamış mesajları aç/kapat', 'bottom');
        setTippy('transcriptionCloseBtn', 'Kapa', 'bottom');
        setTippy('transcriptionTogglePinBtn', 'Sabitlemeyi aç/kapa', 'bottom');
        ...
        setTippy('transcriptShowOnMsg', 'Yeni mesajda çeviriyi göster', 'bottom');
        setTippy('transcriptPersistentMode', 'Konuşma olmadığında durmayı önleyin', 'bottom');
        setTippy('transcriptionSpeechStart', 'Çeviriyi başlat', 'top');
        setTippy('transcriptionSpeechStop', 'Çeviriyi durdur', 'top');
    }
    setupWhiteboard();
...
// ####################################################
// ANA BUTONLAR ARAÇ İPUCUNU TÖNET
// ####################################################
...
function refreshMainButtonsToolTipPlacement() {
    if (!DetectRTC.isMobileDevice) {
        ...
        setTippy('hideMeButton', 'Kişisel görünümü gizlemeyi aç/kapa', placement);
        setTippy('startAudioButton', 'Sesi başlat', placement);
        setTippy('stopAudioButton', 'Sesi durdur', placement);
        setTippy('startVideoButton', 'Video yu başlat', placement);
        setTippy('stopVideoButton', 'Video yu durdur', placement);
        setTippy('startScreenButton', 'Ekran paylaşımını başlat', placement);
        setTippy('stopScreenButton', 'Ekran paylaşımını durdur', placement);
        setTippy('startRecButton', 'Kayda başla', placement);
        setTippy('stopRecButton', 'Kaydı durdur', placement);
        setTippy('raiseHandButton', 'Elini kaldır', placement);
        setTippy('lowerHandButton', 'Elini indir', placement);
        setTippy('emojiRoomButton', 'Emoji yi aç/kapa', placement);
        setTippy('swapCameraButton', 'Kamerayı değiştir', placement);
        setTippy('chatButton', 'Sohbeti aç/kapa', placement);
        setTippy('transcriptionButton', 'Çeviriyi aç/kapa', placement);
        setTippy('whiteboardButton', 'Beyaz tahtayı aç/kapa', placement);
        setTippy('settingsButton', 'Ayarları aç/kapa', placement);
        setTippy('aboutButton', 'Bu proje hakkında', placement);
        setTippy('exitButton', 'Odayı terket', placement);
    }
}
...
function getRoomId() {
    ...
    console.log('Doğrudan katıl', { room: roomId });
...
async function initRoom() {
    if (!isAudioAllowed && !isVideoAllowed && !joinRoomWithoutAudioVideo) {
        openURL(`/permission?room_id=${room_id}&message=Hem Ses hem de Videoya izin verilmiyor`);
    } else {
        setButtonsInit();
        handleSelectsInit();
        await whoAreYou();
...
async function initEnumerateDevices() {
    console.log('01 ----> init Cihazları Numaralandır');
...
async function enumerateVideoDevices(stream) {
    console.log('02 ----> Video Cihazlarını Al');
...
async function enumerateAudioDevices(stream) {
    console.log('03 ----> Ses Cihazlarını Al');
...
// ####################################################
// SES/VİDEO/EKRAN DÜĞMELERİNİ BAŞLAT
// ####################################################
...
// ####################################################
// MİKROFON SES SEVİYESİ GÖSTERGESİ
// ####################################################
...
function getScreen() {
    ...
    if (screen) {
        ...
        if (queryScreen != null && (navigator.getDisplayMedia || navigator.mediaDevices.getDisplayMedia)) {
            console.log('Doğrudan katılma', { screen: queryScreen });
            return queryScreen;
        }
    }
    console.log('Doğrudan katıl', { screen: false });
    return false;
}
...
function getNotify() {
    ...
    if (notify) {
        ...
        if (queryNotify != null) {
            console.log('Doğrudan katıl', { notify: queryNotify });
            return queryNotify;
        }
    }
    notify = localStorageSettings.share_on_join;
    console.log('Doğrudan katıl', { notify: notify });
    return notify;
}
...
function isPeerPresenter() {
    ...
    if (presenter) {
        ...
        if (queryPresenter != null) {
            console.log('Doğrudan katıl yeniden bağlan', { isPresenter: queryPresenter });
            return queryPresenter;
        }
    }
    console.log('Doğrudan katıl yeniden bağlan', { presenter: false });
    return false;
}
...
function getPeerName() {
    ...
    if (isHtml(name)) {
        console.log('Doğrudan katıl', { name: 'Invalid name' });
        return 'Geçersiz isim';
    }
    console.log('Doğrudan katıl', { name: name });
    return name;
}
...
function getPeerToken() {
    ...
    console.log('Doğrudan katıl', { token: queryToken });
    return queryToken;
}
...
function getRoomPassword() {
    ...
    if (roomPassword) {
        ...
        console.log('Doğrudan katıl', { password: roomPassword });
        return roomPassword;
    }
    return false;
}
...
// ####################################################
// YAPILANDIRMAYI BAŞLAT
// ####################################################

async function checkInitConfig() {
    const localStorageInitConfig = lS.getLocalStorageInitConfig();
    console.log('04.5 ----> Başlangıç yapılandırmasını al', localStorageInitConfig);
...
// #############################################################
// ADINIZI GİRİN | SES/VİDEO'yu Etkinleştirme/Devre Dışı Bırakma
// #############################################################

async function whoAreYou() {
    console.log('04 ----> Kimsiniz?');
    ...
    try {
        ...
        if (serverButtons) {
            ...
            console.log('04 ----> AXIOS ODA BUTONLARI AYARLARI', {
                serverButtons: serverButtons,
                clientButtons: BUTTONS,
            });
        }
    } catch (error) {
        console.error('04 ----> AXIOS YAPILANDIRMA HATASI ALINDI', error.message);
    }
    ...
    Swal.fire({
        ...
        inputValidator: (name) => {
            if (!name) return 'Lütfen adınızı giriniz';
            if (name.length > 30) return 'Adınız maksimum 30 karakter olmalıdır';
            name = filterXSS(name);
            if (isHtml(name)) return 'Geçersiz isim!';
            if (!getCookie(room_id + '_name')) {
...
async function shareRoom(useNavigator = false) {
    if (navigator.share && useNavigator) {
        try {
            ...
            userLog('info', 'Oda başarıyla paylaşıldı', 'top-end');
        } catch (err) {
            share();
        }
    } else {
    ...
    function share() {
        ...
        Swal.fire({
            ...
            confirmButtonText: `URL'i kopyala`,
...
function copyRoomURL() {
    ...
    userLog('info', 'Toplantı URL i panoya kopyalandı 👍', 'top-end');
}
        ...
        preConfirm: () => {
            ...
            const roomPassword =
                isRoomLocked && (room_password || rc.RoomPassword)
                    ...
                    : '';
            const email = '';
            const emailSubject = `Lütfen ${BRAND.app.name} Görüntülü Sohbet Toplantımıza katılın`;
            const emailBody = `Toplantının planlandığı tarih: ${newLine} DateTime: ${selectedDateTime} ${newLine}${roomPassword}Katılmak için tıklayın: ${RoomURL} ${newLine}`;
...
function joinRoom(peer_name, room_id) {
    if (rc && rc.isConnected()) {
        console.log('Zaten bir odaya bağlı');
    } else {
        console.log('05 ----> Odaya katıl ' + room_id);
...
function elemDisplay(element, display, mode = 'block') {
    ...
    elem ? (elem.style.display = display ? mode : 'none') : console.error('elemDisplay bulunamadı', element);
}
...
function handleButtons() {
    ...
    refreshVideoDevices.onclick = async () => {
        await refreshMyVideoDevices();
        userLog('info', 'Yenilenen video cihazları', 'top-end');
    };
    refreshAudioDevices.onclick = async () => {
        await refreshMyAudioDevices();
        userLog('info', 'Yenilenen ses cihazları', 'top-end');
    };
    ...
    startAudioButton.onclick = async () => {
        ...
        if (moderator.audio_cant_unmute) {
            return userLog('warning', 'Moderatör sesi açmanıza izin vermiyor', 'top-end', 6000);
        }
        ...
        console.log('SESİ BAŞLAT producerExist --->', producerExist);
    ...
    stopAudioButton.onclick = async () => {
        ...
        const producerExist = rc.producerExist(RoomClient.mediaType.audio);
        console.log('SESİ DURDUR producerExist --->', producerExist);
    ...
    startVideoButton.onclick = async () => {
        ...
        if (moderator.video_cant_unhide) {
            return userLog('warning', 'Moderatör, göstermenize izin vermiyor', 'top-end', 6000);
        }
    ...
    startScreenButton.onclick = async () => {
        ...
        if (moderator.screen_cant_share) {
            return userLog('warning', 'Moderatör ekranı paylaşmanıza izin vermiyor', 'top-end', 6000);
        }
...
// ####################################################
// KULLANICI BAŞLATMAYI YÖNET
// ####################################################

function setButtonsInit() {
    if (!DetectRTC.isMobileDevice) {
        setTippy('initAudioButton', 'Sesi aç/kapa', 'top');
        setTippy('initVideoButton', 'Videoyu aç/kapa', 'top');
        setTippy('initAudioVideoButton', 'Ses ve videoyu aç/kapa', 'top');
        setTippy('initStartScreenButton', 'Ekran paylaşımını aç/kapa', 'top');
        setTippy('initStopScreenButton', 'Ekran paylaşımını aç/kapa', 'top');
    }
...
async function setSelectsInit() {
    if (localStorageDevices) {
        console.log('04.0 ----> Daha önce Yerel Depolama Cihazlarını edinin', localStorageDevices);
        //
        ...
        //
        console.log('04.4 ----> Şu tarihten sonra Yerel Depolama Cihazlarını edinin:', lS.getLocalStorageDevices());
    }
...
async function changeCamera(deviceId) {
    ...
    await navigator.mediaDevices
        ...
        .then((camStream) => {
            ...
            console.log(
                '04.5 ----> Başlangıç kamerası video akışı başarıyla eklendi',
...
function handleMediaError(mediaType, err) {
    ...
    switch (err.name) {
        ...
        case 'DevicesNotFoundError':
            errMessage = 'Gerekli parça eksik';
            break;
        case 'NotReadableError':
        case 'TrackStartError':
            errMessage = 'Zaten kullanımda';
            break;
        case 'OverconstrainedError':
        case 'ConstraintNotSatisfiedError':
            errMessage = 'Kısıtlamalar mevcut cihazlar tarafından karşılanmadı';
            break;
        case 'NotAllowedError':
        case 'PermissionDeniedError':
            errMessage = 'Tarayıcıda izin reddedildi';
            break;
        case 'TypeError':
            errMessage = 'Boş kısıtlama nesnesi';
            break;
        default:
    ...
    <ul style="text-align: left">
        <li>Ortam türü: ${mediaType}</li>
        <li>Hata adı: ${err.name}</li>
        <li>
            <p>Hata mesajı:</p>
    ...
    popupHtmlMessage(null, image.forbidden, 'Erişim engellendi', html, 'center', redirectURL);

    throw new Error(
        `${mediaType} cihazı [${err.name}] için erişim reddedildi: ${errMessage} yaygın getUserMedia hatalarını kontrol edin`,
    );
}
    ...
    if (joinRoomWithScreen) {
        await navigator.mediaDevices
            ...
            .then((screenStream) => {
                ...
                console.log('04.6 ----> Başlangıç ekranı video akışı başarıyla eklendi', initStream);
...
function handleSelects() {
    ...
    switchPushToTalk.onchange = async (e) => {
        ...
        if (!producerExist && !isPushToTalkActive) {
            console.log('Push-to-talk: ses işleyicisini başlat');
            setAudioButtonsDisabled(true);
        ...
        if (producerExist && !isPushToTalkActive) {
            console.log('Push-to-talk: ses işleyicisine devam et');
            await rc.resumeProducer(RoomClient.mediaType.audio);
            rc.updatePeerInfo(peer_name, socket.id, 'audio', true);
        }
        e.target.blur(); // Removes focus from the element
        rc.roomMessage('ptt', isPushToTalkActive);
        console.log(`Push-to-talk etkinleştirilmiş: ${isPushToTalkActive}`);
    };
    document.addEventListener('keydown', async (e) => {
        ...
        if (e.code === 'Space') {
            ...
            rc.updatePeerInfo(peer_name, socket.id, 'audio', true);
            isSpaceDown = true;
            console.log('Push-to-talk: ses devam ettirildi');
        }
    });
    document.addEventListener('keyup', async (e) => {
        ...
        if (e.code === 'Space') {
            ...
            rc.updatePeerInfo(peer_name, socket.id, 'audio', false);
            isSpaceDown = false;
            console.log('Push-to-talk: ses duraklatıldı');
        }
    });
    // room
...
function handleRoomEmojiPicker() {
    ...
    function sendEmojiToRoom(data) {
        console.log('Seçilen Emoji', data.native);
        const cmd = {
            type: 'roomEmoji',
            peer_name: peer_name,
            emoji: data.native,
...
// ####################################################
// AYARLARI YEREL DEPOLAMADAN YÜKLE
// ####################################################
...
// ####################################################
// ODA KATILIMCI ETKİNLİĞİ DİNLEYİCİLERİ
// ####################################################

function handleRoomClientEvents() {
    rc.on(RoomClient.EVENTS.startRec, () => {
        console.log('Room event: İstemci kaydetmeye başladı');
        hide(startRecButton);
        show(stopRecButton);
        show(pauseRecButton);
        show(recordingTime);
    ...
    rc.on(RoomClient.EVENTS.pauseRec, () => {
        console.log('Room event: İstemci kayıt işlemini duraklattı');
        hide(pauseRecButton);
        show(resumeRecButton);
    });
    rc.on(RoomClient.EVENTS.resumeRec, () => {
        console.log('Room event: İstemci kayıt işlemini sürdürdü');
        hide(resumeRecButton);
        show(pauseRecButton);
    });
    rc.on(RoomClient.EVENTS.stopRec, () => {
        console.log('Room event: İstemci kaydı durdurdu');
        hide(stopRecButton);
        hide(pauseRecButton);
        hide(resumeRecButton);
        hide(recordingTime);
    ...
    rc.on(RoomClient.EVENTS.pauseAudio, () => {
        console.log('Room event: İstemci sesi duraklattı');
    ...
    rc.on(RoomClient.EVENTS.resumeAudio, () => {
        console.log('Room event: İstemci sesi devam ettirdi');
        hide(startAudioButton);
        show(stopAudioButton);
        setAudioButtonsDisabled(false);
    });
    rc.on(RoomClient.EVENTS.stopAudio, () => {
        console.log('Room event: İstemci sesi durdurdu');
        hide(stopAudioButton);
        show(startAudioButton);
        setAudioButtonsDisabled(false);
        stopMicrophoneProcessing();
    ...
    rc.on(RoomClient.EVENTS.startVideo, () => {
        console.log('Room event: İstemci video yu başlattı');
    ...
    rc.on(RoomClient.EVENTS.pauseVideo, () => {
        console.log('Room event: İstemci video yu duraklattı');
    ...
    rc.on(RoomClient.EVENTS.resumeVideo, () => {
        console.log('Room event: İstemci video yu devam ettirdi');
        hide(startVideoButton);
        show(stopVideoButton);
        setVideoButtonsDisabled(false);
    ...
    rc.on(RoomClient.EVENTS.stopVideo, () => {
        console.log('Room event: İstemci video yu durdurdu');
        hide(stopVideoButton);
        show(startVideoButton);
        setVideoButtonsDisabled(false);
        isVideoPrivacyActive = false;
    ...
    rc.on(RoomClient.EVENTS.startScreen, () => {
        console.log('Room event: İstemci ekranı başlattı');
        hide(startScreenButton);
        show(stopScreenButton);
        // if (isParticipantsListOpen) getRoomParticipants();
    });
    rc.on(RoomClient.EVENTS.pauseScreen, () => {
        console.log('Room event: İstemci ekranı duraklattı');
        hide(startScreenButton);
        show(stopScreenButton);
    });
    rc.on(RoomClient.EVENTS.resumeScreen, () => {
        console.log('Room event: İstemci ekranı devam ettirdi');
        hide(stopScreenButton);
        show(startScreenButton);
    });
    rc.on(RoomClient.EVENTS.stopScreen, () => {
        console.log('Room event: İstemci ekranı durdurdu');
        hide(stopScreenButton);
        show(startScreenButton);
        // if (isParticipantsListOpen) getRoomParticipants();
    });
    rc.on(RoomClient.EVENTS.roomLock, () => {
        console.log('Room event: İstemci odayı kilitledi');
        hide(lockRoomButton);
    ...
    rc.on(RoomClient.EVENTS.roomUnlock, () => {
        console.log('Room event: İstemci odanın kilidini açtı');
        hide(unlockRoomButton);
        show(lockRoomButton);
        isRoomLocked = false;
    });
    rc.on(RoomClient.EVENTS.lobbyOn, () => {
        console.log('Room event: İstemci oda lobisi etkinleştirildi');
    ...
    rc.on(RoomClient.EVENTS.lobbyOff, () => {
        console.log('Room event: İstemci oda lobisi engellendi');
        isLobbyEnabled = false;
    });
    rc.on(RoomClient.EVENTS.hostOnlyRecordingOn, () => {
        if (isRulesActive && !isPresenter) {
            console.log('Room event: yalnızca ana bilgisayar kaydı etkin');
            // Stop recording ...
            if (rc.isRecording() || recordingStatus.innerText != '0s') {
                rc.saveRecording('Room event: yalnızca ana bilgisayar kaydı etkin, kayıt durdurulacak');
            }
            hide(startRecButton);
            hide(recordingImage);
    ...
    rc.on(RoomClient.EVENTS.hostOnlyRecordingOff, () => {
        if (isRulesActive && !isPresenter) {
            console.log('Room event: yalnızca ana bilgisayar kaydı devre dışı');
            show(startRecButton);
            show(recordingImage);
            hide(roomHostOnlyRecording);
    ...
    rc.on(RoomClient.EVENTS.exitRoom, () => {
        console.log('Room event: İstemci odadan ayrıldı');
        if (rc.isRecording() || recordingStatus.innerText != '0s') {
            rc.saveRecording('Room event: İstemci çıkmadan önce kaydı kaydetti');
        }
...
function leaveFeedback() {
    Swal.fire({
        ...
        text: 'SAI-GM Video Chat deneyiminizi değerlendirmek ister misiniz?',
...
function saveObjToJsonFile(dataObj, name) {
    console.log('Veri kaydet', { dataObj: dataObj, name: name });
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (isImageURL(wbCanvasImgURL)) {
                        ...
                        userLog('error', 'URL geçerli bir resim değil', 'top-end');
                    }
                }
            });
            break;
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (wbCanvasImg && wbCanvasImg.size > 0) {
                        ...
                        userLog('error', 'Dosya seçili değil veya boş', 'top-end');
                    }
                }
            });
            break;
...
async function loadPDF(pdfData, pages) {
    ...
    try {
        ...
        console.error('PDF yüklenirken hata oluştu', error.message);
        throw error.message;
    }
}
...
async function pdfToImage(pdfData, canvas) {
    ...
    try {
        ...
        console.error('PDF i resimlere dönüştürürken hata oluştu', error.message);
        throw error.message;
    }
}
...
function addWbCanvasObj(obj) {
    if (obj) {
        ...
        console.error('Geçersiz Giriş. Tuval öğelerinden oluşan bir nesne bekleniyordu');
    }
}
...
function wbUpdate() {
    if (wbIsOpen && (!isRulesActive || isPresenter)) {
        console.log('IsPresenter: beyaz tahta tuvalini odadaki katılımcılara güncelle');
        wbCanvasToJson();
        whiteboardAction(getWhiteboardAction(wbIsLock ? 'lock' : 'unlock'));
    }
}
...
function confirmClearBoard() {
    Swal.fire({
        ...
        text: 'Tahtayı temizlemek istediğinizden emin misiniz?',
        showDenyButton: true,
...
function whiteboardAction(data, emit = true) {
    if (emit) {
        ...
        userLog(
            'info',
            `${data.peer_name} <i class="fas fa-chalkboard-teacher"></i> beyaz tahta eylemi: ${data.action}`,
            'top-end',
        );
    }
...
async function getRoomParticipants() {
    ...
    console.log('*** Sohbet katılımcı listelerini yenile ***');
}
...
function getParticipantsList(peers) {
    ...
    >
        ...
        <div class="about">
            ...
            <div class="status"> <i class="fa fa-circle online"></i> çevrimiçi ${participantsCount}</div>
        </div>`;
    ...
    if (!isRulesActive || isPresenter) {
        ...
        if (BUTTONS.participantsList.sendFileAllButton) {
            li += `<li><button class="btn-sm ml5" id="sendAllButton" onclick="rc.selectFileToShare('${socket.id}', true)">${_PEER.sendFile} Dosyayı herkesle paylaş</button></li>`;
        }

        li += `<li><button class="btn-sm ml5" id="sendVideoToAll" onclick="rc.shareVideo('all');">${_PEER.sendVideo} Sesi/Videoyu herkesle paylaşın</button></li>`;

        if (BUTTONS.participantsList.ejectAllButton) {
            li += `<li><button class="btn-sm ml5" id="ejectAllButton" onclick="rc.peerAction('me','${socket.id}','eject',true,true)">${_PEER.ejectPeer} Tüm katılımcıları çıkar</button></li>`;
        }
            ...
            if (isRulesActive && isPresenter) {
                ...
                >
                    ...
                    <div class="about">
                        ...
                        <div class="status"> <i class="fa fa-circle online"></i> çevrimiçi <i id="${peer_id}-unread-msg" class="fas fa-comments hidden"></i> </div>
                    </div>
                ...
                if (BUTTONS.participantsList.sendFileButton) {
                    li += `<li><button class="btn-sm ml5" id='${peer_id}___shareFile' onclick="rc.selectFileToShare('${peer_id}', false)">${peer_sendFile} Dosya paylaş</button></li>`;
                }

                li += `<li><button class="btn-sm ml5" id="${peer_id}___sendVideoTo" onclick="rc.shareVideo('${peer_id}');">${_PEER.sendVideo} Ses/Video paylaş</button></li>`;

                if (BUTTONS.participantsList.geoLocationButton) {
                    li += `<li><button class="btn-sm ml5" id='${peer_id}___geoLocation' onclick="rc.askPeerGeoLocation(this.id)">${peer_geoLocation} Coğrafi konumu al</button></li>`;
                }
                if (BUTTONS.participantsList.banButton) {
                    li += `<li><button class="btn-sm ml5" id='${peer_id}___pBan' onclick="rc.peerAction('me',this.id,'ban')">${peer_ban} Katılımcıyı yasakla</button></li>`;
                }
                if (BUTTONS.participantsList.ejectButton) {
                    li += `<li><button class="btn-sm ml5" id='${peer_id}___pEject' onclick="rc.peerAction('me',this.id,'eject')">${peer_eject} Katılımcıyı çıkar</button></li>`;
                }
...
function setParticipantsTippy(peers) {
    ...
    if (!DetectRTC.isMobileDevice) {
        ...
        setTippy('stopAllButton', 'Tüm katılımcıların ekran paylaşımını durdur', 'top');
        //
        for (let peer of Array.from(peers.keys())) {
            const peer_info = peers.get(peer).peer_info;
            const peer_id = peer_info.peer_id;
    ...
    Swal.fire({
        ...
        <div id="about">
            ...
            Email:<a 
                ...
                href="mailto:bulent.cetin@alchemy.com.tr?subject=SAI-GM Video Chat SFU bilgi"> 
                bulent.cetin@alchemy.com.tr
            </a>
            <br /><br />
            <hr />
            <span>&copy; 2024 SAI-GM Video Chat SFU, tüm hakları saklıdır</span>
            <hr />
        </div>
        `,
        showClass: { popup: 'animate__animated animate__fadeInDown' },
