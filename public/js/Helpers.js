...
class MixedAudioRecorder {
    ...
    createAudioContext() {
        if (window.AudioContext) {
            ...
            throw new Error('Web Audio API si bu tarayıcıda desteklenmiyor');
        }
    }
    ...
    getMixedAudioStream(audioStreams) {
        ...
        audioStreams.forEach((stream) => {
            ...
            console.log('MediaStreamAudioDestinationNode a eklenecek karışık ses parçaları --->', stream.getTracks());
    ...
    stopMixedAudioStream() {
        ...
        console.log('Karışık Ses Akışını Durdur');
    }
}
