...
function adultContent() {
    if (
        confirm(
            '18+ UYARI! YALNIZCA YETİŞKİNLER!\n\n18 yaşında veya daha büyük yetişkinlerin görüntüleyebileceği açık materyal. Bu siteye erişebilmek için en az 18 yaşında olmanız gerekir!\n\nDevam ederek 18 yaşından büyük olduğunuzu kabul ve onaylıyorsunuz.',
        )
    ) {
...
console.log('Kameraya veya Sese İzin Ver', {
    room_id: room_id,
    message: message,
});
