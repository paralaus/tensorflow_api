...
// ####################################################
// RESPONSIVE KATILIMCILARIN GÖRÜNÜMÜ
// ####################################################
...
function resizeVideoMedia() {
    ...
    // döngü (bunun optimize edilmesi daha iyi olur)
    let i = 1;
    while (i < 5000) {
...
function resizeMainButtons() {
    ...
    if (isButtonsBarVertical) {
        ...
        // Ana düğmeler yatay olarak hizalanır
...
// ####################################################
// PENCERE YÜKLEME/YENİDEN BOYUTLANDIRMA FONKSİYONU
// ####################################################
